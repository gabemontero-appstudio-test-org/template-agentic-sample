...
!!! info
    ...
    **Source Code Repository:** [https://github.com/gabemontero-appstudio-test-org/template-agentic-sample](https://github.com/gabemontero-appstudio-test-org/template-agentic-sample)
...
To access the llama-stack-template-agentic-sample application that was deployed using the Software Template, complete the following instructions:
...
|----------|-------------|------------|
| `INFERENCE_MODEL` | Model for classification: `openai/gpt-4o-mini` | Software Template Form |
